...
set CLASSPATH=%DITA_DIR%lib\Saxon-HE-12.5.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\ant-apache-resolver-1.10.15.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\commons-io-2.14.0.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\logback-classic-1.5.17.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\logback-core-1.5.17.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\slf4j-api-2.0.17.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\com.elovirta.pdf\lib\pdf-generator-0.8.0.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\batik-all-1.18.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fontbox-2.0.33.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fop-core-2.10.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fop-events-2.10.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fop-pdf-images-2.10.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\fop-util-2.10.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\jcl-over-slf4j-2.0.7.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\pdfbox-2.0.33.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.fop\lib\xmlgraphics-commons-2.10.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.dita.pdf2.xep\lib\xep.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\org.lwdita\lib\org.lwdita-5.9.1.jar;%CLASSPATH%
